  ...
  public function render()
  {
    ...
    foreach ($weeks as $week) {
      ...
      foreach ($days as $day) {
        ...
        $weekday = Carbon::parse($target)->dayOfWeek;
        ...
        if ($startDay <= $target && $toDay >= $target) {
          $html[] = '<td class="past-day border ' . $weekClass . '">';
        } else {
          $html[] = '<td class="border ' . $day->getClassName() . ' ' . $weekClass . '">';
        }
